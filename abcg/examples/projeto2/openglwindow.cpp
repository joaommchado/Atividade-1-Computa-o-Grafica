...
void OpenGLWindow::initializeGL() {
  ...
  // Load model
  loadModelFromFile(getAssetsPath() + "car.obj");
...
void OpenGLWindow::paintGL() {
  ...
  float aleatorioA = 0.0f + static_cast <float> (rand()) /( static_cast <float> (RAND_MAX/(1.0f-(0.0f))));
  float aleatorioX = 0.0f + static_cast <float> (rand()) /( static_cast <float> (RAND_MAX/(1.0f-(0.0f))));
  float aleatorioY = 0.0f + static_cast <float> (rand()) /( static_cast <float> (RAND_MAX/(1.0f-(0.0f))));
  float aleatorioZ = 0.0f + static_cast <float> (rand()) /( static_cast <float> (RAND_MAX/(1.0f-(0.0f))));
  ...
  glUniform4f(colorLoc, aleatorioA, aleatorioX, aleatorioY, aleatorioZ);
